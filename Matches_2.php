...
<head>
    ...
    <title>Ticket Rush | Matches(الدوري المصري)</title>
    <style>
        .link-container {
            display: flex;
...
<body>
    ...
    <section class="main-movies">
        ...
        <div class="link-container">
            ...
            <a href="Matches_2.php" style="color: #185099; font-weight: 800; background: #fff;">الدوري المصري</a>
    ...
    $con = new mysqli("localhost","root","","ticket");
                  if($con->connect_error){
                      die("failed to connect:".$con->connect_error);}
                        ...
                        $q= "SELECT * FROM event WHERE event_title = ('الدوري المصري')";
                        $result = $con->query($q);
                      } 
