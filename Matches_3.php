...
<head>
    ...
    <title>Ticket Rush | Matches(كأس الكونفدرالية الافريقية)</title>
    <style>
        .link-container {
            display: flex;
...
<body>
    ...
    <section class="main-movies">
        ...
        <div class="link-container">
            <a href="Matches_3.php" style="color: #185099; font-weight: 800; background: #fff;">كأس الكونفدرالية الافريقية</a>
            <a href="Matches_2.php">الدوري المصري</a>
            <a href="Matches.php">البطولات</a>
        </div>
    ...
    $con = new mysqli("localhost","root","","ticket");
                  if($con->connect_error){
                      die("failed to connect:".$con->connect_error);}
                        ...
                        $q= "SELECT * FROM event WHERE event_title = ('كأس الكونفدرالية الافريقية')";
                        $result = $con->query($q);
                      } 
