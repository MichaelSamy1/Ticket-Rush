        ...
        <div class="tickets">
            <div class="ticket-selector">
                ...
                <div class="seats">
                    ...
                    <form method="POST" action="book_seat.php" id="seatForm">
                        ...
                        <div class="all-seats">
                            ...
                            for ($i = 1; $i <= $rows; $i++) {
                                for ($j = 1; $j <= $cols; $j++) {
                                    ...
                                    echo "<input type='checkbox' name='selectedSeats[]' id='s{$i}{$j}' value='{$seat_number}' class='seat-checkbox' />";
                        ...
                        <div class="price">
                            ...
                            <div class="seemore_Book">
                                <button type="submit" name="submit" id="bookSeats" class="book">تأكيد المقاعد</button>
                            </div>
                        </div>
                    </form>
                </div>
